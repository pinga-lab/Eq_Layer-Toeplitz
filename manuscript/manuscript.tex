...
its first column \citep[][ p. 221]{golub-vanloan2013}. So, 
...
\ref{eq:A-x-oriented-example}--\ref{eq:Aq-y-oriented}).
To illustrate equations \ref{eq:C-first-column-blocks} and \ref{eq:Cq-first-column}, 
consider our $y$-oriented grid illustrated in Figure 1b. In this case, the resulting 
