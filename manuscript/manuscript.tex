...
{time necessary to run 50 iterations of the \citet{siqueira-etal2017} method and the one presented in this work. With the limitation of $16$ Gb of memory RAM in our system, we could test only up to $22\,500$ obervation points.}
...
{(a) Fitted gravity data produced by our modification of the fast equivalent layer proposed by \citet{siqueira-etal2017}. (b) Gravity residuals, defined as the difference between the observed data in Figure 4 and the predicted data in panel a, with their mean of $8.264e-7$ and standard deviation of $0.0144$ mGal.}
\newpage
