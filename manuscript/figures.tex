...
\plot{Figure10_r1}{width=6cm}{
	{Application to synthetic data.
	(a) Gravity data produced by the synthetic sources at $z = -XXXX$ m.
	...
	mean $XXXXXX$ mGal and standard deviation $XXXXXX$ mGal. 
	(c) Residuals between the simulated data shown in a and the upward-continued 
	gravity data obtained with our method (not shown), with mean $XXXXX$ mGal and 
	standard deviation $XXXXX$ mGal. 
